...
Section proofs.
  ...
  Lemma ctor_null_ok : verify[linked_list_cpp.module] ctor_null_spec.
  Proof. verify_spec. go. rewrite /nodeR. work. Qed.

  Lemma ctor_next_ok : verify[linked_list_cpp.module] ctor_next_spec.
  Proof. verify_spec. go. rewrite /nodeR. work. Qed.

  Lemma dtor_ok : verify[linked_list_cpp.module] dtor_spec.
  Proof. verify_spec. go. rewrite /nodeR. work. Qed.
End proofs.
...
Section proofs.
  Context `{Σ : cpp_logic} `{MOD: linked_list_cpp.module ⊧ σ}.

  Lemma get_data_ok : verify[linked_list_cpp.module] get_data_spec.
  Proof. verify_spec. go. Qed.

  Lemma set_data_ok : verify[linked_list_cpp.module] set_data_spec.
  Proof. verify_spec. go. Qed.
End proofs.
...
(*| ### Verifying Constructor and Destructor |*)
  Lemma ctor_ok : verify[linked_list_cpp.module] ctor_spec.
  Proof. verify_spec. go. Qed.
  ...
  Lemma push_ok : verify[linked_list_cpp.module] push_spec.
  Proof. verify_spec. go. Qed.
  ...
  Lemma pop_ok : verify[linked_list_cpp.module] pop_spec.
  Proof.
    verify_spec. go.
    wp_if => NULL_ROOT.
    - (* root non-null *) go.
  ...
  Lemma length_ok : verify[linked_list_cpp.module] length_spec.
  Proof.
    verify_spec. go.
    (*| Specify a loop invariant |*)
  Abort.

  Lemma reverse_ok : verify[linked_list_cpp.module] reverse_spec.
  Proof.
    verify_spec. go.
    (*| Specify a loop invariant |*)
  Abort.
  ...
  Lemma append_ok : verify[linked_list_cpp.module] append_spec.
  Proof.
    verify_spec. go.
    wp_if => NULL_ROOT.
  ...
  Lemma merge_ok : verify[linked_list_cpp.module] merge_spec.
  Proof.
    verify_spec. go.
    (*| Specify a loop invariant |*)
  Abort.
