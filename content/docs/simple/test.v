...
cpp.spec "test()" as test_spec with
  (\post emp).
(*@@
The `emp` tells you that the function doesn't return any [resources]({{ "resource" }}), but we'll get into that more later.
...
Proof.
(*@@
This sets up a theorem for our function that states that the function satisfies the specification. In this case, this means that executing the function will not produce any [undefined behavior]({{ "undefined-behavior" }}).
